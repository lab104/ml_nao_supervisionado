...
class Actor(nn.Module):
    def __init__(self, state_size, action_size):
        ...
        self.l1 = nn.Conv2d(3, 128, kernel_size=(4,4), stride=(2,2)) 
        self.d1 = nn.Dropout2d(0.1)
        self.l3 = nn.Conv2d(128, 64, kernel_size=(4,4), stride=(2,2))
        self.d3 = nn.Dropout2d(0.1)
        self.l4 = nn.Conv2d(64, 8, kernel_size=(4,4), stride=(2,2))
        self.d4 = nn.Dropout2d(0.1)        
        self.l6 = nn.Flatten()                    
        self.l7 = nn.Linear(2336,2048)
        self.d7 = nn.Dropout(0.1)
        self.l7b = nn.Linear(2048,2048)
        self.l8 = nn.Linear(2048, self.action_size)
    ...
    def forward(self, state):
        ...
        output = F.relu(self.l7(output))        
        output = self.d7(output)
        output = F.relu(self.l7b(output))
        output = F.relu(self.l8(output))
